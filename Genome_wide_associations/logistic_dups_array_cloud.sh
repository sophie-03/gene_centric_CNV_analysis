...
do
    ...
    Rscript /define/home/smatthews/pheWAS/scripts/logistic_dups_cloud.R "group_$SLURM_ARRAY_TASK_ID/temp_cnvs.rawcnv" "$SLURM_ARRAY_TASK_ID" "${PHENOTYPE}"
...
cat group_*/temp_logistic.txt > "${PHENOTYPE}"_dups_logistic_output.txt
