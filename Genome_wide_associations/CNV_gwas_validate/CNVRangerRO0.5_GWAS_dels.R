...
#read in cnv calls
cnv_file <- paste0("/data4/smatthews/pheWAS/cnv_GWAS/cnv_regions_RO_del_split/cnv_regions_RO_del_part", part_num, ".txt")
...
output_file <- paste0("/data4/smatthews/pheWAS/cnv_GWAS/", pheno_name, "_del_CNVRangerRO0.5_logistic_results.txt")
